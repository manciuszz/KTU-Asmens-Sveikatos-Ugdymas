...
public final class TextBuffer {
    ...
    public char[] expandCurrentSegment() {
        ...
        char[] copyOf = ArraysCompat.copyOf(cArr, length == 262144 ? 262145 : Math.min(262144, length + (length >> 1)));
    ...
    public char[] expandCurrentSegment(int i) {
        ...
        cArr = ArraysCompat.copyOf(cArr, i);
        this._currentSegment = cArr;
        return cArr;
    }
    ...
    private char[] resultArray() {
        ...
        if (this._inputStart >= 0) {
            ...
            return ArraysCompat.copyOfRange(this._inputBuffer, i2, i + i2);
        }
        i = size();
        if (i < 1) {
            return NO_CHARS;
