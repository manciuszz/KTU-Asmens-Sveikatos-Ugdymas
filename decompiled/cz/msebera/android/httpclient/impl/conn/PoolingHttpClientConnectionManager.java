...
public class PoolingHttpClientConnectionManager implements HttpClientConnectionManager, ConnPoolControl<HttpRoute>, Closeable {
    ...
    public void releaseConnection(cz.msebera.android.httpclient.HttpClientConnection r10, java.lang.Object r11, long r12, java.util.concurrent.TimeUnit r14) {
...
*/
        ...
        monitor-enter(r10);
        r2 = cz.msebera.android.httpclient.impl.conn.CPoolProxy.detach(r10);	 Catch:{ all -> 0x00c2 }
        if (r2 != 0) goto L_0x000e;	 Catch:{ all -> 0x00c2 }
    L_0x000c:
        monitor-exit(r10);	 Catch:{ all -> 0x00c2 }
    L_0x000d:
        return;	 Catch:{ all -> 0x00c2 }
    L_0x000e:
        r0 = r2.getConnection();	 Catch:{ all -> 0x00c2 }
        r0 = (cz.msebera.android.httpclient.conn.ManagedHttpClientConnection) r0;	 Catch:{ all -> 0x00c2 }
        r4 = r0.isOpen();	 Catch:{ all -> 0x00ce }
        if (r4 == 0) goto L_0x007b;	 Catch:{ all -> 0x00ce }
    L_0x001a:
        if (r14 == 0) goto L_0x00c5;	 Catch:{ all -> 0x00ce }
    L_0x001c:
        r1 = r14;	 Catch:{ all -> 0x00ce }
    L_0x001d:
        r2.setState(r11);	 Catch:{ all -> 0x00ce }
        r2.updateExpiry(r12, r1);	 Catch:{ all -> 0x00ce }
        r4 = r9.log;	 Catch:{ all -> 0x00ce }
        r4 = r4.isDebugEnabled();	 Catch:{ all -> 0x00ce }
        if (r4 == 0) goto L_0x007b;	 Catch:{ all -> 0x00ce }
    L_0x002b:
        r4 = 0;	 Catch:{ all -> 0x00ce }
        r4 = (r12 > r4 ? 1 : (r12 == r4 ? 0 : -1));	 Catch:{ all -> 0x00ce }
        if (r4 <= 0) goto L_0x00c9;	 Catch:{ all -> 0x00ce }
    L_0x0031:
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00ce }
        r4.<init>();	 Catch:{ all -> 0x00ce }
        r5 = "for ";	 Catch:{ all -> 0x00ce }
        r4 = r4.append(r5);	 Catch:{ all -> 0x00ce }
        r5 = r1.toMillis(r12);	 Catch:{ all -> 0x00ce }
        r5 = (double) r5;	 Catch:{ all -> 0x00ce }
        r7 = 4652007308841189376; // 0x408f400000000000 float:0.0 double:1000.0;	 Catch:{ all -> 0x00ce }
        r5 = r5 / r7;	 Catch:{ all -> 0x00ce }
        r4 = r4.append(r5);	 Catch:{ all -> 0x00ce }
        r5 = " seconds";	 Catch:{ all -> 0x00ce }
        r4 = r4.append(r5);	 Catch:{ all -> 0x00ce }
        r3 = r4.toString();	 Catch:{ all -> 0x00ce }
    L_0x0055:
        r4 = r9.log;	 Catch:{ all -> 0x00ce }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00ce }
        r5.<init>();	 Catch:{ all -> 0x00ce }
        r6 = "Connection ";	 Catch:{ all -> 0x00ce }
        r5 = r5.append(r6);	 Catch:{ all -> 0x00ce }
        r6 = r9.format(r2);	 Catch:{ all -> 0x00ce }
        r5 = r5.append(r6);	 Catch:{ all -> 0x00ce }
        r6 = " can be kept alive ";	 Catch:{ all -> 0x00ce }
        r5 = r5.append(r6);	 Catch:{ all -> 0x00ce }
        r5 = r5.append(r3);	 Catch:{ all -> 0x00ce }
        r5 = r5.toString();	 Catch:{ all -> 0x00ce }
        r4.debug(r5);	 Catch:{ all -> 0x00ce }
    L_0x007b:
        r5 = r9.pool;	 Catch:{ all -> 0x00c2 }
        r4 = r0.isOpen();	 Catch:{ all -> 0x00c2 }
        if (r4 == 0) goto L_0x00cc;	 Catch:{ all -> 0x00c2 }
    L_0x0083:
        r4 = r2.isRouteComplete();	 Catch:{ all -> 0x00c2 }
        if (r4 == 0) goto L_0x00cc;	 Catch:{ all -> 0x00c2 }
    L_0x0089:
        r4 = 1;	 Catch:{ all -> 0x00c2 }
    L_0x008a:
        r5.release(r2, r4);	 Catch:{ all -> 0x00c2 }
        r4 = r9.log;	 Catch:{ all -> 0x00c2 }
        r4 = r4.isDebugEnabled();	 Catch:{ all -> 0x00c2 }
        if (r4 == 0) goto L_0x00bf;	 Catch:{ all -> 0x00c2 }
    L_0x0095:
        r5 = r9.log;	 Catch:{ all -> 0x00c2 }
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00c2 }
        r4.<init>();	 Catch:{ all -> 0x00c2 }
        r6 = "Connection released: ";	 Catch:{ all -> 0x00c2 }
        r4 = r4.append(r6);	 Catch:{ all -> 0x00c2 }
        r6 = r9.format(r2);	 Catch:{ all -> 0x00c2 }
        r6 = r4.append(r6);	 Catch:{ all -> 0x00c2 }
        r4 = r2.getRoute();	 Catch:{ all -> 0x00c2 }
        r4 = (cz.msebera.android.httpclient.conn.routing.HttpRoute) r4;	 Catch:{ all -> 0x00c2 }
        r4 = r9.formatStats(r4);	 Catch:{ all -> 0x00c2 }
        r4 = r6.append(r4);	 Catch:{ all -> 0x00c2 }
        r4 = r4.toString();	 Catch:{ all -> 0x00c2 }
        r5.debug(r4);	 Catch:{ all -> 0x00c2 }
    L_0x00bf:
        monitor-exit(r10);	 Catch:{ all -> 0x00c2 }
        goto L_0x000d;	 Catch:{ all -> 0x00c2 }
    L_0x00c2:
        r4 = move-exception;	 Catch:{ all -> 0x00c2 }
        monitor-exit(r10);	 Catch:{ all -> 0x00c2 }
        throw r4;
    L_0x00c5:
        r1 = java.util.concurrent.TimeUnit.MILLISECONDS;	 Catch:{ all -> 0x00ce }
        goto L_0x001d;	 Catch:{ all -> 0x00ce }
    L_0x00c9:
        r3 = "indefinitely";	 Catch:{ all -> 0x00ce }
        goto L_0x0055;
    L_0x00cc:
        r4 = 0;
        goto L_0x008a;
    L_0x00ce:
        r4 = move-exception;
        r5 = r4;
        r6 = r9.pool;	 Catch:{ all -> 0x00c2 }
        r4 = r0.isOpen();	 Catch:{ all -> 0x00c2 }
        if (r4 == 0) goto L_0x0115;	 Catch:{ all -> 0x00c2 }
    L_0x00d8:
        r4 = r2.isRouteComplete();	 Catch:{ all -> 0x00c2 }
        if (r4 == 0) goto L_0x0115;	 Catch:{ all -> 0x00c2 }
    L_0x00de:
        r4 = 1;	 Catch:{ all -> 0x00c2 }
    L_0x00df:
        r6.release(r2, r4);	 Catch:{ all -> 0x00c2 }
        r4 = r9.log;	 Catch:{ all -> 0x00c2 }
        r4 = r4.isDebugEnabled();	 Catch:{ all -> 0x00c2 }
        if (r4 == 0) goto L_0x0114;	 Catch:{ all -> 0x00c2 }
    L_0x00ea:
        r6 = r9.log;	 Catch:{ all -> 0x00c2 }
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00c2 }
        r4.<init>();	 Catch:{ all -> 0x00c2 }
        r7 = "Connection released: ";	 Catch:{ all -> 0x00c2 }
        r4 = r4.append(r7);	 Catch:{ all -> 0x00c2 }
        r7 = r9.format(r2);	 Catch:{ all -> 0x00c2 }
        r7 = r4.append(r7);	 Catch:{ all -> 0x00c2 }
        r4 = r2.getRoute();	 Catch:{ all -> 0x00c2 }
        r4 = (cz.msebera.android.httpclient.conn.routing.HttpRoute) r4;	 Catch:{ all -> 0x00c2 }
        r4 = r9.formatStats(r4);	 Catch:{ all -> 0x00c2 }
        r4 = r7.append(r4);	 Catch:{ all -> 0x00c2 }
        r4 = r4.toString();	 Catch:{ all -> 0x00c2 }
        r6.debug(r4);	 Catch:{ all -> 0x00c2 }
    L_0x0114:
