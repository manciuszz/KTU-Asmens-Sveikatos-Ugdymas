...
public class JsonStreamerEntity implements HttpEntity {
    ...
    private static final byte[] STREAM_NAME = escape(SettingsActivity.NAME);
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        if (keysCount > 0) {
            ...
            AsyncHttpClient.log.i(LOG_TAG, "Uploaded JSON in " + Math.floor((double) (elapsedTime / 1000)) + " seconds");
        }
        os.write(125);
        os.flush();
