        ...
        while (this.ii >= 0) {
            ...
            if (serie.isVisible()) {
                ...
                while (this.jj < this.mStacked.mPointList.size()) {
                    ...
                    if (this.jj == 0) {
                        this.mPath.reset();
                        this.mPath.moveTo((this.sX + this.bX) + (((float) this.jj) * this.aX), this.eY - ((pY - this.bY) * this.aY));
                    } else {
                        this.mPath.lineTo((this.sX + this.bX) + (((float) this.jj) * this.aX), this.eY - ((pY - this.bY) * this.aY));
                    }
                ...
                if (serie.mFillColor != 0) {
                    ...
                    this.mPathFill.lineTo((this.sX + this.bX) + (((float) (this.mStacked.mPointList.size() - 1)) * this.aX), this.eY);
