...
public final class CharsToNameCanonicalizer {
    ...
    private void copyArrays() {
        Object[] objArr = this._symbols;
        this._symbols = (String[]) ArraysCompat.copyOf(objArr, objArr.length);
        objArr = this._buckets;
        this._buckets = (Bucket[]) ArraysCompat.copyOf(objArr, objArr.length);
    }
